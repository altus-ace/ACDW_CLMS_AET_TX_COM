...
CREATE PROCEDURE [ast].[pdw_Load_FailedCareOpps]--'2021-11-15',9 
    @QMDate DATE
    , @ClientKey INT
AS
    ...
    INSERT INTO [adw].[FailedCareOpps]
           ...
           ,[MbrCOPInContractFlg]
           ,[Exported]
           ,[ExportedDate]) -- DECLARE @QMDATE DATE = '2021-11-15' DECLARE @ClientKey INT = 9 DECLARE @EffectiveDate DATE = '2021-11-01'
     SELECT	DISTINCT
           qm.LoadDate
           ,qm.QMDate
           ,qm.ClientKey
